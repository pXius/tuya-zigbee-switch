...
update-indexes:
	@$(PYTHON) $(HELPERS_PATH)/make_z2m_ota_index.py --db_file $(DEVICE_DB_FILE) $(OTA_FILE) $(Z2M_INDEX_FILE) --board $(BOARD)
ifneq ($(PLATFORM_PREFIX),silabs)
ifneq ($(FROM_STOCK_MANUFACTURER_ID),null)
ifneq ($(FROM_STOCK_IMAGE_TYPE),null)
	@$(PYTHON) $(HELPERS_PATH)/make_z2m_ota_index.py --db_file $(DEVICE_DB_FILE) $(FROM_TUYA_OTA_FILE) $(Z2M_INDEX_FILE) --board $(BOARD)
endif
endif
endif
	@$(PYTHON) $(HELPERS_PATH)/make_z2m_ota_index.py --db_file $(DEVICE_DB_FILE) $(FORCE_OTA_FILE) $(Z2M_FORCE_INDEX_FILE) --board $(BOARD)
